    ...
    <section className={styles['about']} ref={imgRef} id="about">
      <Container>
        ...
        <div ref={textRef} className={styles['about-content']}>
          <p>
            Over a decade ago, I was drowning in the despondency of yet another workday. My success as the top regional
            ...
            intention to address my experience.
          </p>
          <p>
            Exhausted from the drama, with an unrecognizable version of myself at the wheel, I intentionally swerved off
            the interstate in an attempt to take my own life. But in that half-second, my reflexes responded, and I
            yanked the wheel away from disaster. As I clipped the guardrail on I 405, something changed...
          </p>
          <p className={styles['about-content-gradient']}>I uncovered a power within myself</p>
          <p>
            ...a burning desire to reverse a trend that happens daily to sixty-five million people in this country
            alone. This catalyst has since become John Doe Movement - a transformational roadmap of mindset, behaviors,
            and tools that transform workplace cultures and drive results.
          </p>
